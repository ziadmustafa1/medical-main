...
import image1 from "../../aswets/facebookfooter.png"
import image2 from "../../aswets/linkedlinfooter.png"
import image3 from "../../aswets/instafooter.png"
import image4 from "../../aswets/twitterfooter.png"
        ...
        <div className="footer">
            <div className="footer-section flex items-start flex-wrap justify-center mt-44 gap-4">
                ...
                <div className="footer-div4 py-8">
                    ...
                    <ul className="flex">
                        <li className=' text-4xl p-2 rounded-xl'><a href="" target="_blank"><img src={image1} alt="" /></a></li>
                        <li className=' text-4xl p-2 rounded-xl'><a href="" target="_blank"><img src={image2} alt="" /></a></li>
                        <li className=' text-4xl p-2 rounded-xl'><a href="" target="_blank"><img src={image3} alt="" /></a></li>
                        <li className=' text-4xl p-2 rounded-xl'><a href="" target="_blank"><img src={image4} alt="" /></a></li>
                    </ul>
                </div>
            </div>
