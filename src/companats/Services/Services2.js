...
import '../../Page/Services/Services.css'
const Services2 = () => {
  return (
    <div>
      <div className="about-us-section py-5">
        <ul className="about-us-ul flex flex-wrap items-center justify-center py-10 gap-5">
          <li className="AboutUSli shadow-2xl">
            ...
            <p className="p-about-us-color">Etiam ante ante, molestie vitae cursus ac, pharetra euismod libero.</p>
            </li><li className="AboutUSli shadow-2xl">
